...
##########
#
# This file starts from a copy of ../../sync-dev-blessed-masters.rb file, on June, 18th.
# The original script is used every day by Jenkins, so to be able to test a new feature, the script was copied.
# TODO: see if it will be interested to keep to distinct files (one for addons, one for others projects)
#
##########
