...
ISSUE=SWF-4418
CURRENT_DEVELOP_VERSION_PREFIX=5.1.x
NEXT_DEVELOP_VERSION_PREFIX=5.2.x
...
GATEIN_DEP_CURRENT_VERSION_PREFIX=1.6.x
GATEIN_DEP_NEXT_VERSION_PREFIX=1.7.x
...
MAVEN_DEPMGT_CURRENT_VERSION_PREFIX=14
MAVEN_DEPMGT_NEXT_VERSION_PREFIX=15
...
ADDONS_MANAGER_CURRENT_VERSION_PREFIX=1.3.x
ADDONS_MANAGER_NEXT_VERSION_PREFIX=1.4.x
...
ES_EMBEDDED_CURRENT_VERSION_PREFIX=2.1.x
ES_EMBEDDED_NEXT_VERSION_PREFIX=2.2.x
...
OPENAM_CURRENT_VERSION_PREFIX=2.1.x
OPENAM_NEXT_VERSION_PREFIX=2.2.x
OPENAM_CURRENT_VERSION=${OPENAM_CURRENT_VERSION_PREFIX}-SNAPSHOT
OPENAM_NEXT_VERSION=${OPENAM_NEXT_VERSION_PREFIX}-SNAPSHOT

REMOTE_EDIT_CURRENT_VERSION_PREFIX=2.1.x
REMOTE_EDIT_NEXT_VERSION_PREFIX=2.2.x
...
WEB_CONF_CURRENT_VERSION_PREFIX=1.2.x
WEB_CONF_NEXT_VERSION_PREFIX=1.3.x
...
PUSH_NOTIFICATIONS_CURRENT_VERSION_PREFIX=1.0.x
PUSH_NOTIFICATIONS_NEXT_VERSION_PREFIX=1.1.x
