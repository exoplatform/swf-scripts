...
# Maven DEPMGT
DEPMGT_ORIGIN_VERSION=15-SNAPSHOT
DEPMGT_TARGET_VERSION=15.x-$BRANCH-SNAPSHOT
# GateIn DEPMGT
GATEIN_DEP_ORIGIN_VERSION=1.7.x-SNAPSHOT
