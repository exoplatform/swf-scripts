...
ISSUE=SWF-3955
JUZU_ORIGIN_VERSION=1.1.x-SNAPSHOT
JUZU_TARGET_VERSION=1.2.x-$BRANCH-SNAPSHOT
...
#  git checkout ${ORIGIN_BRANCH} && git branch | grep -v "${ORIGIN_BRANCH}" | xargs git branch -d -D
  ...
  ## Juzu
  $SCRIPTDIR/../replaceInFile.sh "<org.juzu.version>$JUZU_ORIGIN_VERSION</org.juzu.version>" "<org.juzu.version>$JUZU_TARGET_VERSION</org.juzu.version>" "pom.xml -not -wholename \"*/target/*\""
