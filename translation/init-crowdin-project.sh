...
NEWS_VERSION=2.4.x
TASK_ADDON_VERSION=3.4.x
WEB_CONFERENCING_ADDON_VERSION=2.4.x
PUSH_NOTIFICATIONS_ADDON_VERSION=2.4.x
WALLET_ADDON_VERSION=2.4.x
KUDOS_ADDON_VERSION=2.4.x
PERKSTORE_ADDON_VERSION=2.4.x
GAMIFICATION_VERSION=2.4.x
ONLYOFFICE_VERSION=2.4.x
APPCENTER_VERSION=2.4.x
DIGITAL_WORKPLACE_VERSION=1.4.x
MEEDS_VERSION=1.4.x
AGENDA_VERSION=1.3.x
JITSI_VERSION=1.3.x
ANALYTICS_VERSION=1.3.x
NOTES_VERSION=1.2.x
POLL_VERSION=1.1.x
GAMIFICATION_GITHUB_VERSION=1.1.x
