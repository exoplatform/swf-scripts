...
# Stable versions
PLF_VERSION=6.2.x
CHAT_ADDON_VERSION=3.2.x
NEWS_VERSION=2.2.x
TASK_ADDON_VERSION=3.2.x
WEB_CONFERENCING_ADDON_VERSION=2.2.x
PUSH_NOTIFICATIONS_ADDON_VERSION=2.2.x
WALLET_ADDON_VERSION=2.2.x
KUDOS_ADDON_VERSION=2.2.x
PERKSTORE_ADDON_VERSION=2.2.x
GAMIFICATION_VERSION=2.2.x
ONLYOFFICE_VERSION=2.2.x
APPCENTER_VERSION=2.2.x
DIGITAL_WORKPLACE_VERSION=1.2.x
MEEDS_VERSION=1.2.x
AGENDA_VERSION=1.1.x
JITSI_VERSION=1.1.x
ANALYTICS_VERSION=1.1.x
NOTES_VERSION=1.0.x
