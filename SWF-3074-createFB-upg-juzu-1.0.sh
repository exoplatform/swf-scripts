...
function createFB(){
  ...
  set -e
	# Recreate the branch from $ORIGIN_BRANCH
...
#  replaceInPom.sh "<org.exoplatform.ide.version>1.4.x-SNAPSHOT</org.exoplatform.ide.version>" "<org.exoplatform.ide.version>1.4.x-ide-$BRANCH-SNAPSHOT</org.exoplatform.ide.version>"
  replaceInPom.sh "<org.exoplatform.depmgt.version>9-SNAPSHOT</org.exoplatform.depmgt.version>" "<org.exoplatform.depmgt.version>10-$BRANCH-SNAPSHOT</org.exoplatform.depmgt.version>"  
  git commit -m"$ISSUE : Create $BRANCH branch and update projects versions" -a
  git push origin $TARGET_BRANCH --set-upstream --force
